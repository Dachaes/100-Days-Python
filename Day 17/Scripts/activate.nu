...
let virtual-env = "D:\Coding\02. 100개의 프로젝트로 Python 개발 완전 정복 - Udemy (221216-)\Day 17"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Coding\02. 100개의 프로젝트로 Python 개발 완전 정복 - Udemy (221216-)\Day 17\Scripts\deactivate.nu"
